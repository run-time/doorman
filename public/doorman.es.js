const c = () => {
  ...
  if (typeof window.screen.fontSmoothingEnabled < "u")
    ...
    try {
      for (t = "false", e = document.createElement("canvas"), e.width = "35", e.height = "35", e.style.display = "none", document.body.appendChild(e), r = e.getContext("2d", { willReadFrequently: !0 }), r.textBaseline = "top", r.font = "32px Arial", r.fillStyle = "black", r.strokeStyle = "black", r.fillText("O", 0, 0), n = 8; n <= 32; n = n + 1)
        for (i = 1; i <= 32; i = i + 1)
...
class T {
  ...
  isCanvasSupported() {
    ...
    return !!(e.getContext && e.getContext("2d", { willReadFrequently: !0 }));
  }
  isIE() {
